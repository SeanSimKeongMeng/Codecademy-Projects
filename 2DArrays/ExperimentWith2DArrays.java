...
public class ExperimentWith2DArrays {
    ...
    int[][] shrinkedImg = shrinkVertically(imageData);
    twoDToImage(shrinkedImg, "./shrinked_apple.jpg");

    int[][] invertedImg = invertImage(imageData);
    twoDToImage(invertedImg, "./inverted_apple.jpg");

    int[][] filteredImg = colorFilter(imageData, 75, -130, 30);
    ...
    int [][] randomImg = paintRandomImage(canvas);
    twoDToImage(randomImg, "./random_img.jpg");

    int[] rgba = {25, 55, 150, 255};
    int[][] rectangleInImg = paintRectangle(imageData, 100, 100, 100, 10, getColorIntValFromRGBA(rgba));
    twoDToImage(rectangleInImg, "./rectangle.jpg");

    int[][] genRectangles = generateRectangles(imageData, 1);
    twoDToImage(genRectangles, "./randomRect.jpg");
	}
    ...
    Random rand = new Random();
      for (int i = 0 ; i < numRectangles ; i++) {
        ...
        int randBlue = rand.nextInt(256);
        int[] rgbaValues = {randRed, randGreen, randBlue, 255};
        int color = getColorIntValFromRGBA(rgbaValues);
        int[][] rectangleInImg = paintRectangle(canvas, width, height, rowPosition, colPosition, color);
      }
